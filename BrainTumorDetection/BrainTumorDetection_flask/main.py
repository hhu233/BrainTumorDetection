...
from utils import predictImg, chatApi
...
class VideoProcessingApp:
    def __init__(self, host='0.0.0.0', port=5000):
        ...
        self.port = port
        self.setup_routes()
        self.DeepSeek = 'sk-5e8f2ba92561409a8e773bd3ee1c1527'
        self.Qwen = 'sk-qjxwwuzdixaxnqbkqhvcuthxgdvmnosspbqqidsaynqyukxl'
        self.data = {}  # 存储接收参数
        self.paths = {
    ...
    def predictImg(self):
        ...
        if self.data["ai"] == 'DeepSeek' and self.data["status"] == 200:
            ...
            for i in list_input:
                ...
                text += "，"
            # 构造通用消息
            text += "请你帮我生成一些实质性的建议，包括建议检查项目、手术方案、药物选择、注意事项等。只需回答我要的结果。"
            messages = [
                {"role": "user",
                 "content": text}
            ]
