<template>
	<div class="login-container">
		...
		<div class="login-box animate__animated animate__fadeIn">
			<div class="title">
				<h2>基于YOLOV11的脑部肿瘤检测系统</h2>
				<p>Brain tumor detection system based on YOLOV11</p>
			</div>
...
.login-container {
	...
	background: linear-gradient(135deg, #E5DFFF 0%, #FFDE59 100%);
	padding: 20px;
}
...
.login-btn {
	...
	letter-spacing: 1px;
	border-radius: 8px;
	background: linear-gradient(to right, #E5DFFF 0%, #FFDE59 100%);
	border: none;
	margin-top: 10px;
